...
public class Abstinence : MonoBehaviour {
    ...
    void MakePoweupMove()
    {
        ...
        Vector2 PowerUpSize = StdPongPlayScript.PowerupsText[0].transform.localScale;//size of powerup
        StdPongPlayScript.PowerupsText[0].transform.position = new Vector2(XposSTDBall + PowerUpSize.x, YposSTDBall); //transform condom blinking text
    ...
    private void OnTriggerEnter2D(Collider2D otherCollider)
    {
        ...
        else if (myBottomline != null)
        {
            ...
            StdPongPlayScript.PowerupsText[0].transform.position = new Vector2(12, 12); //transform condom blinking text
        }
