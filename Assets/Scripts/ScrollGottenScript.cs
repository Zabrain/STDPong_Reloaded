...
public class ScrollGottenScript : MonoBehaviour
{
    //buttons to STD
    ...
    public void ScabiesSTD()
    {
        if (HighestLevel >= 1)
        {
            PlayerPrefs.SetInt("ScrollToSee", 1);//set the Arcade level
            LoadTheSTDScroll();
        }
        else
        {
    ...
    public void GenitalWartsSTD()
    {
        if (HighestLevel >= 2)
        {
            PlayerPrefs.SetInt("ScrollToSee", 2);//set the Arcade level
            LoadTheSTDScroll();
        }
        else
        {
    ...
    public void HerpesSTD()
    {
        if (HighestLevel >= 3)
        {
            PlayerPrefs.SetInt("ScrollToSee", 3);//set the Arcade level
            LoadTheSTDScroll();
        }
        else
        {
    ...
    public void TrichomoniasisSTD()
    {
        if (HighestLevel >= 4)
        {
            PlayerPrefs.SetInt("ScrollToSee", 4);//set the Arcade level
            LoadTheSTDScroll();
        }
        else
        {
    ...
    public void HepatitsBSTD()
    {
        if (HighestLevel >= 5)
        {
            PlayerPrefs.SetInt("ScrollToSee", 5);//set the Arcade level
            LoadTheSTDScroll();
        }
        else
        {
    ...
    public void ChlamydiaSTD()
    {
        if (HighestLevel >= 6)
        {
            PlayerPrefs.SetInt("ScrollToSee", 6);//set the Arcade level
            LoadTheSTDScroll();
        }
        else
        {
    ...
    public void SyphilisSTD()
    {
        if (HighestLevel >= 7)
        {
            PlayerPrefs.SetInt("ScrollToSee", 7);//set the Arcade level
            LoadTheSTDScroll();
        }
        else
        {
    ...
    public void GonorrheaSTD()
    {
        if (HighestLevel >= 8)
        {
            PlayerPrefs.SetInt("ScrollToSee", 8);//set the Arcade level
            LoadTheSTDScroll();
        }
        else
        {
    ...
    public void HIVSTD()
    {
        if (HighestLevel >= 9)
        {
            PlayerPrefs.SetInt("ScrollToSee", 9);//set the Arcade level
            LoadTheSTDScroll();
        }
        else
        {
    ...
    public void AIDSSTD()
    {
        if (HighestLevel >= 10)
        {
            PlayerPrefs.SetInt("ScrollToSee", 10);//set the Arcade level
            LoadTheSTDScroll();
        }
        else
        {
