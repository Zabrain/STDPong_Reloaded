...
public class QuizScript : MonoBehaviour {
    ...
    public void NextButton() //next question
    {
        ...
        if (CurrentQuestion >= 5) //question has finished
        {
            ...
            if(QuestionMeterValue > 0.3f)//not all questions answered
            {
    ...
    void LoadQuestionArrays()
    {
        ...
        else if (MainDirectorScript.strLevel == "Genital Warts")
        {
            ...
            QuizQuestions[2, 0] = "Which of these tests recommended to find Genital Warts in women is the:";//Question 3
